...
import com.yassine.lafryhi.jee.seance8.security.repositories.AppRoleRepository;
import com.yassine.lafryhi.jee.seance8.security.repositories.AppUserRepository;
...
public class SecurityServiceImpl implements SecurityService {
    ...
    public AppUser saveNewUser(String username, String password, String verifyPassword) {
        if (!password.equals(verifyPassword)) throw new RuntimeException("Not match !");
    ...
    public AppRole saveNewRole(String roleName, String description) {
        ...
        if (role != null) throw new RuntimeException("The role : " + roleName + " already exists !");
        role = new AppRole();
